...
## 3. 最近更新 (V13.5.0 - Daily Word UX)

### 3.1 每日一词 UI 改进 (2026-01-28)
- **交互优化**：
  - **iOS**: 移除独立关闭按钮，在三点更多菜单中整合 Level 选择、New Batch 刷新和 Close 关闭功能。
  - **Web**: 新增三点更多菜单，将 Level 难度选择器和 New Batch 按钮移入菜单，底部控制栏简化为 Prev/Next 导航。
