...
> **最后更新/Last Updated**: 2026-02-07 v2.0.0
...
10. **主题色与风格**：所有UI设计风格，主题色锁定为 **Kine Yellow** (#FFD700)。所有UI设计风格，Web 端遵循 **macOS26** 风格，iOS 端遵循 **iOS26** 风格。
11. **多语言交互**：所有回复、任务、文档均使用中文。严禁硬编码文字，确保支持 简中、英、德、日 四国语言。
12. **Documentation Versioning (文档版本号管理)**：凡对系统核心文档（PRD、API、UserScenarios、DataModel 等）进行内容更新，必须同步升级其内部版本号并刷新“最后更新”日期，以确保文档的可追溯性和一致性。
