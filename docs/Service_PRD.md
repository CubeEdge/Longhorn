...
| **经销商维修** | 经销商本地完成维修（不寄回总部） | 经销商维修单 |
| **RMA返厂服务** | 设备需寄回深圳总部维修 | RMA返厂单 |
...
维修需求判断
├── 经销商可自行处理？
│   ├── 是 → 创建【经销商维修单 SVC】→ 经销商经销商维修 → 配件消耗记录
│   └── 否 → 需要寄回Kinefinity？
│           ├── 是 → 创建【RMA返厂单】→ 物流 → 总部维修
│           └── 否 → 继续排查 或 关闭咨询工单
```
...
| B1 一级经销商经销商维修 | 经销商 | 经销商库存 | 客户（过保） | 月度/季度结算 |
| B2 二级经销商经销商维修 | 经销商 | 临时发货 | 客户（过保） | 单次PI |
...
| **咨询工单** | KYYMM-XXXX | K2602-0001 | 咨询、问题排查等服务的统一入口 |
| **RMA返厂单** | RMA-{C}-YYMM-XXXX | RMA-D-2602-0015 | 设备返回Kinefinity总部维修，每台设备独立RMA号 |
| **经销商维修单** | SVC-D-YYMM-XXXX | SVC-D-2602-0001 | 经销商经销商维修，不寄回总部 |
