...
| | 问题大类 | 稳定性/素材/监看/SSD/音频/兼容性/时码/硬件结构 |
...
| 功能 | 说明 |
|-----|------|
| 需求收集 | 从咨询工单/经销商反馈/客户自助/内部建议收集 |
| AI智能识别 | 自动识别“希望/建议/能不能”关键词 |
| 需求分类 | 自动分类为UI/功能/性能/兼容性/硬件/其他 |
| 相似聚合 | AI识别重复需求，建议合并 |
| 投票机制 | 多个客户可对同一需求投票 |
| 优先级评估 | 根据请求频次、客户重要性给出建议 |
| 版本规划 | 分配到目标版本（如：固件8025） |
| 推送闭环 | 功能发布后自动通知相关客户 |
