...
| 工单类型 | ID格式 | 示例 | 说明 |
|---------|--------|------|------|
| **咨询工单** | KYYMM-XXXX | K2602-0001 | 一般服务记录/咨询，统一入口 |
...
#### 1.6.5.2 获客渠道 acquisition_channel
...
#### 1.6.5.3 关联经销商 parent_dealer_id
