...
| **2. 诊断** | 判定故障/方案 | `op_diagnosing` | **OP** (技师) | [ 提交诊断 ] ➡️ **必填**: 故障分析、初步方案、备件需求、**保修判定**。 |
| **3. 商务审核** | 客户确认/报价 | `ms_review` | **MS** (客服) | [ 批准维修 ] ➡️ **必填**: 保外须关联 PI 号或上传确认截图。 |
| **4. 维修中** | 物理维修/更换 | `op_repairing` | **OP** (技师) | [ 维修完成 ] ➡️ **必填**: **具体维修内容详述**、老化测试结论。 |
| **5. 结算审核** | 收款/对账/释放 | `ms_closing` | **GE / MS** | [ 释放发货 ] ➡️ **必填**: 非保单须填入收款金额、日期、渠道。 |
