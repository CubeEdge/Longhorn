...
const CustomerFormModal: React.FC<CustomerFormModalProps> = ({
    ...
    return (
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-content fade-in" onClick={e => e.stopPropagation()} style={{ maxWidth: 700, maxHeight: '90vh', overflow: 'auto' }}>
                <h3 style={{ marginBottom: 24 }}>{isEditing ? 'Edit Account' : 'Add New Account'}</h3>
                <form onSubmit={handleSubmit}>
                    {/* Tab Navigation for dealer/organization */}
                    {shouldShowTabs && (
                        <div style={{ display: 'flex', gap: 4, background: 'rgba(255,255,255,0.05)', padding: 4, borderRadius: 10, marginBottom: 20, height: '44px', alignItems: 'center' }}>
                            <button
                                type="button"
