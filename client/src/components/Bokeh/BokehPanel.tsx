                ...
                <div ref={scrollRef} style={{ flex: 1, overflowY: 'auto', padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        ...
                        (() => {
                            const getBannerContent = () => {
                                switch (wikiContext.type) {
                                    ...
                                    case 'wiki_article_view':
                                        return {
                                            icon: <FileText size={14} color="#00A650" />,
                            ...
                            return (
                                <div style={{
                                    ...
                                    {banner.subtitle && (
                                        <div style={{ marginTop: '6px', fontSize: '11px', color: '#00A650' }}>
                                            {banner.subtitle}
                                        </div>
                                    )}
                                </div>
                    ...
                    {messages.map(msg => (
                        <div key={msg.id} style={{
                            ...
                            <div style={{
                                padding: '12px 16px',
                                borderRadius: '12px',
                                background: msg.role === 'user' ? '#00A650' : 'rgba(255, 255, 255, 0.08)',
                                color: '#fff',
                                fontSize: '14px',
                                lineHeight: '1.5',
                    ...
                    {loading && (
                        <div style={{ alignSelf: 'flex-start', display: 'flex', alignItems: 'center', gap: '8px', padding: '12px', opacity: 0.6 }}>
                            <Loader2 size={16} className="animate-spin" color="#00A650" />
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', gap: '4px', paddingBottom: '8px', paddingRight: '8px' }}>
                            ...
                            <button
                                ...
                                disabled={!input.trim()}
                                style={{
                                    background: input.trim() ? '#00A650' : 'rgba(255,255,255,0.1)',
