...
import { X, Calendar, AlertTriangle, Save, Loader2, Upload, FileText, Box, Building, User } from 'lucide-react';
            ...
            <div style={{
                ...
                <div style={{ padding: 24, overflowY: 'auto', flex: 1 }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ marginBottom: 12 }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                ...
                                <span style={{ fontSize: 14, color: '#fff' }}>
                                    {fetchingProduct ? '加载中...' : (productInfo?.model_name || productName || '未知型号')}
                                </span>
                            </div>
                        </div>
                        ...
                        {productInfo?.sales_channel && (
                            <div>
                                <div style={{ fontSize: 12, color: '#666', marginBottom: 4 }}>销售渠道</div>
                    ...
                    <div style={{ marginBottom: 20 }}>
                        <label style={{ display: 'block', fontSize: 12, color: '#aaa', marginBottom: 12, textTransform: 'uppercase', letterSpacing: 0.5 }}>
                            归属信息
                        </label>
                    ...
                    <div style={{
                        ...
                        <div style={{ fontSize: 13, color: '#FFD700', lineHeight: 1.5 }}>
                            ...
                            >
                                ...
                                {invoiceFile ? (
                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
                                        ...
                                        <span style={{ color: '#10B981', fontSize: 13 }}>{invoiceFileName}</span>
                                    </div>
                                ) : (
                                    <div>
                                        <Upload size={24} color="#666" style={{ marginBottom: 8 }} />
                                        <div style={{ fontSize: 13, color: '#888' }}>点击上传发票图片或PDF</div>
                                        <div style={{ fontSize: 11, color: '#666', marginTop: 4 }}>支持 JPG、PNG、PDF，最大 5MB</div>
                                    </div>
                                )}
                            </div>
                        </div>
                    ...
                    {error && (
                        <div style={{
                            ...
                            borderRadius: 8, padding: 12, color: '#EF4444', fontSize: 13
                        }}>
                            {error}
                        </div>
                    )}
                ...
                <div style={{
                    ...
                    <button
                        ...
                        disabled={loading || !saleSource || !saleDate || (saleSource === 'invoice' && !invoiceFile)}
                        style={{
                            padding: '10px 24px', background: '#3B82F6', border: 'none',
                            color: '#fff', borderRadius: 8, fontWeight: 600,
                            cursor: loading || !saleSource || !saleDate || (saleSource === 'invoice' && !invoiceFile) ? 'not-allowed' : 'pointer',
                            display: 'flex', alignItems: 'center', gap: 8,
                            opacity: loading || !saleSource || !saleDate || (saleSource === 'invoice' && !invoiceFile) ? 0.7 : 1
                        }}
                    >
