        ...
        VStack(spacing: 24) {
            ...
            VStack(spacing: 12) {
                ...
                Button {
                    ...
                    ToastManager.shared.show(String(localized: "link.copied"), type: .success, style: .prominent)
                } label: {
                ...
                if usePassword && !password.isEmpty {
                    HStack {
                        ...
                        Button {
                            ...
                            ToastManager.shared.show(String(localized: "toast.password_copied"), type: .success, style: .prominent)
                        } label: {
