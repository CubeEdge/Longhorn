...
## 更新摘要
**变更内容**
- 移除了独立的parts_master定价结构，改为统一的SKU定价系统
- 新增material_id字段支持材料标识管理
- 增强了产品分类功能和验证逻辑
- 更新了数据库架构和API接口设计
- 实现了价格数据的统一管理和同步
...
**更新** 系统架构已升级为统一的SKU定价系统，移除了独立的parts_master定价结构，增强了材料标识和分类管理功能。新的架构实现了价格数据的集中管理和实时同步，提升了系统的可维护性和扩展性。
...
- [PartsCatalogPage.tsx:41-75](file://client/src/components/PartsManagement/PartsCatalogPage.tsx#L41-L75)
- [PartsInventoryPage.tsx:61-100](file://client/src/components/PartsManagement/PartsInventoryPage.tsx#L61-L100)
- [PartsConsumptionPage.tsx:85-129](file://client/src/components/PartsManagement/PartsConsumptionPage.tsx#L85-L129)
- [PartsSettlementPage.tsx:93-140](file://client/src/components/PartsManagement/PartsSettlementPage.tsx#L93-L140)
...
**图表来源**
- [parts-master.js:9-449](file://server/service/routes/parts-master.js#L9-L449)
- [parts-inventory.js:8-516](file://server/service/routes/parts-inventory.js#L8-L516)
- [parts-consumption.js:8-482](file://server/service/routes/parts-consumption.js#L8-L482)
- [parts-settlement.js:36-637](file://server/service/routes/parts-settlement.js#L36-L637)
...
- [parts-master.js:1-449](file://server/service/routes/parts-master.js#L1-L449)
- [parts-inventory.js:1-516](file://server/service/routes/parts-inventory.js#L1-L516)
- [parts-consumption.js:1-482](file://server/service/routes/parts-consumption.js#L1-L482)
...
| 获取BOM推荐配件 | GET | `/api/v1/parts-master/bom` | 根据产品型号获取BOM推荐配件 |
