...
## 更新摘要
**所做更改**
- 新增三层产品架构章节，详细描述产品目录、商品规格和设备台账的三层结构
- 更新产品管理API，增加新的产品模型、SKU和设备台账管理端点
- 新增产品管理前端组件，包括产品模型管理、SKU管理和设备台账管理界面
- 更新数据模型章节，增加三层架构相关的新表和字段
- 新增产品架构迁移脚本，确保现有数据向三层架构的平滑过渡
- 更新保修计算引擎，增加三层架构下的产品关联和保修计算逻辑
- 新增产品管理权限控制，区分不同角色对产品管理功能的访问权限
- 更新工作区协作功能，增加产品管理相关的协作流程
