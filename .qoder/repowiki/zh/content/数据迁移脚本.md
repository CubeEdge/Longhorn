...
- [scripts/build-client.sh](file://scripts/build-client.sh)
...
- [server/migrations/039_add_attachments_count.sql](file://server/migrations/039_add_attachments_count.sql)
...
- [server/service/migrations/031_parts_master.sql](file://server/service/migrations/031_parts_master.sql)
- [server/service/migrations/032_service_uploads.sql](file://server/service/migrations/032_service_uploads.sql)
...
## 更新摘要
**所做更改**
- 新增工单附件计数系统，包括 attachments_count 字段添加和现有数据填充
- 新增客户端构建脚本，提供安全的本地构建流程
- 新增附件检查脚本，支持工单附件的诊断和验证
- 更新附件系统架构，支持工单活动附件和文档上传管理
- 新增服务上传表迁移，支持保修发票和其他服务附件的跟踪
- 新增PI和维修报告文档系统迁移，支持工作流文档管理
- 新增配件主数据和库存集成迁移，支持维修配件管理
- 新增产品数据丰富化系统，提供完整的测试数据创建能力
- 新增用户迁移修复系统，专门处理历史数据中的用户名称迁移
- 新增RMA账户修复系统，解决特定工单的账户关联问题
- 新增统一工单系统准备工具链，涵盖工单ID格式修复和数据一致性校验
- 新增产品安装基线迁移系统，提供从现有数据推断产品所有权、保修信息和销售溯源的能力
- 新增增强工单数据修复系统，提供完整的工单数据诊断、修复和完整性验证功能
- 新增活动参与者修复系统，提供工单活动数据的完整修复能力
- 新增缺失账户修复系统，提供从报告者名称自动关联账户的能力
- 新增缺失参与者修复系统，提供自动扫描@提及并添加参与者记录的能力
- 新增报告者快照迁移系统，为工单表添加reporter_snapshot字段
- 新增账户类型组织化迁移系统，提供账户类型统一的功能
- 新增审计软删除系统，提供完整的工单删除和审计功能
- 新增回收站管理系统，提供软删除项目的恢复和清理功能
...
本项目包含多个数据迁移脚本，用于处理不同场景下的数据库结构变更和数据转换。这些脚本涵盖了经销商数据迁移、知识库功能扩展、**产品家族分类迁移**、AI使用日志记录、**账户联系人架构迁移**、**产品安装基线迁移**、**活动参与者修复**、**缺失账户链接修复**、**缺失参与者修复**、**报告者快照迁移**、**账户类型组织化迁移**、**审计和软删除系统**、**工单附件计数系统**、**客户端构建系统**、**附件检查系统**、**服务上传管理**、**文档工作流系统**、**配件主数据管理**、**产品数据丰富化**、**用户迁移修复**、**RMA账户修复**、**统一工单系统准备**等多个方面。

**更新** 新增了工单附件计数系统、客户端构建脚本、附件检查脚本、服务上传管理、文档工作流系统、配件主数据管理、产品数据丰富化、用户迁移修复、RMA账户修复、统一工单系统准备、产品安装基线迁移、增强工单数据修复、活动参与者修复、缺失账户修复、缺失参与者修复、报告者快照迁移、账户类型组织化迁移、审计软删除系统、回收站管理系统等重要功能。这些新增功能提供了完整的附件管理和文档工作流支持，包括：

- **工单附件计数系统**：自动计算和维护工单附件数量，支持高效查询和统计
- **客户端构建系统**：提供安全的本地构建流程，避免沙箱确认问题
- **附件检查系统**：支持工单附件的诊断和验证，便于问题排查
- **服务上传管理**：跟踪保修发票和其他服务附件的上传和管理
- **文档工作流系统**：支持PI和维修报告的完整工作流管理
- **配件主数据管理**：集成配件主数据和库存管理系统
- **工单活动附件支持**：完整的工单活动附件管理架构
- **文档审计日志**：完整的文档变更跟踪和审计功能
- **产品数据丰富化**：提供完整的测试数据创建能力
- **用户迁移修复**：专门处理历史数据中的用户名称迁移
- **RMA账户修复**：解决特定工单的账户关联问题
- **统一工单系统准备**：提供完整的工单ID格式修复和数据一致性校验
- **产品安装基线迁移**：提供从现有数据推断产品所有权、保修信息和销售溯源的能力
- **增强工单数据修复**：提供完整的工单数据诊断、修复和完整性验证功能
- **活动参与者修复**：提供工单活动数据的完整修复能力
- **缺失账户修复**：提供从报告者名称自动关联账户的能力
- **缺失参与者修复**：提供自动扫描@提及并添加参与者记录的能力
- **报告者快照迁移**：为工单表添加reporter_snapshot字段
- **账户类型组织化迁移**：提供账户类型统一的功能
- **审计软删除系统**：提供完整的工单删除和审计功能
- **回收站管理系统**：提供软删除项目的恢复和清理功能
...
subgraph "附件管理系统"
AttachmentsCount[039_add_attachments_count.sql]
AttachmentCheck[check_attachments.js]
TicketAttachments[ticket_attachments表]
end
subgraph "客户端构建系统"
BuildClient[build-client.sh]
ClientBuild[客户端构建]
end
subgraph "服务上传系统"
ServiceUploads[032_service_uploads.sql]
UploadTracking[上传跟踪]
end
subgraph "文档工作流系统"
PIReports[030_pi_and_report_tables.sql]
DocumentAudit[文档审计日志]
end
subgraph "配件主数据系统"
PartsMaster[031_parts_master.sql]
PartsConsumption[配件消耗记录]
end
subgraph "产品架构迁移"
...
ServerMigrations --> AttachmentsCount
...
ServiceUploads --> UploadTracking
PIReports --> DocumentAudit
PartsMaster --> PartsConsumption
BuildClient --> ClientBuild
AttachmentsCount --> TicketAttachments
AttachmentCheck --> TicketAttachments
end
```

**图表来源**
- [server/migrations/039_add_attachments_count.sql:1-11](file://server/migrations/039_add_attachments_count.sql#L1-L11)
- [scripts/build-client.sh:1-21](file://scripts/build-client.sh#L1-L21)
- [server/scripts/check_attachments.js:1-36](file://server/scripts/check_attachments.js#L1-L36)
- [server/service/migrations/032_service_uploads.sql:1-21](file://server/service/migrations/032_service_uploads.sql#L1-L21)
...
- [server/service/migrations/031_parts_master.sql:1-226](file://server/service/migrations/031_parts_master.sql#L1-L226)
...
**新增** 全新的工单附件计数系统，提供高效的工单附件数量管理和查询支持：

```mermaid
flowchart TD
AttachmentsCount[工单附件计数系统] --> AddColumn[添加attachments_count字段]
AddColumn --> UpdateCounts[更新现有工单计数]
UpdateCounts --> QueryOptimization[查询性能优化]
QueryOptimization --> RealTimeUpdates[实时计数更新]
RealTimeUpdates --> Complete[系统完成]
```
...
**1. 字段定义**
- `attachments_count` INTEGER 类型，默认值为 0
- 存储每个工单的附件数量
- 支持快速查询和统计操作

**2. 数据填充策略**
- 使用子查询统计每个工单的附件数量
- 基于 `ticket_attachments` 表进行关联统计
- 自动填充现有工单的附件计数
...
```mermaid
flowchart TD
AttachmentCheck[附件检查系统] --> TicketLookup[工单查找]
TicketLookup --> ActivityAttachments[活动附件查询]
ActivityAttachments --> DiagnosticCheck[诊断活动检查]
DiagnosticCheck --> RecentAttachments[最近附件查看]
RecentAttachments --> Complete[检查完成]
```
...
```mermaid
flowchart TD
BuildClient[客户端构建系统] --> CleanDist[清理dist目录]
CleanDist --> SafeDelete[安全删除方式]
SafeDelete --> BuildProcess[构建客户端]
BuildProcess --> Success[构建完成]
Success --> Complete[系统完成]
```
...
**1. 安全删除机制**
- 使用 `trash` 命令进行安全删除（如果可用）
- 降级到手动删除方式（避免使用 `-rf` 参数）
- 防止沙箱确认问题
...
```mermaid
flowchart TD
ServiceUploads[服务上传管理] --> CreateTable[创建service_uploads表]
CreateTable --> UploadTracking[上传跟踪]
UploadTracking --> IndexOptimization[索引优化]
IndexOptimization --> Complete[管理完成]
```
...
```mermaid
flowchart TD
PIReports[PI和维修报告系统] --> CreatePI[创建PI表]
CreatePI --> CreateReports[创建维修报告表]
CreateReports --> DocumentAudit[创建文档审计日志]
DocumentAudit --> TicketReferences[添加工单引用]
TicketReferences --> Complete[工作流完成]
```
...
**1. 审计记录**
- 记录所有文档操作（创建、更新、提交、审核、批准、拒绝、发布、删除）
- 跟踪操作者和变更详情
- 支持按文档类型和ID查询
...
```mermaid
flowchart TD
PartsMaster[配件主数据管理] --> CreatePartsMaster[创建配件主数据表]
CreatePartsMaster --> CreateConsumption[创建配件消耗记录]
CreateConsumption --> CreateSettlements[创建经销商结算表]
CreateSettlements --> CreateBOM[创建BOM关联表]
CreateBOM --> CreateTransactions[创建库存交易记录]
CreateTransactions --> Complete[管理系统完成]
```
...
**更新** 整体数据迁移架构采用分层设计，支持本地和远程操作，并包含新的账户联系人架构、产品家族分类系统、智能文档更新系统、专用数据修复系统、文件权限优化系统、新增的产品数据丰富化、用户迁移修复、RMA账户修复、统一工单系统准备系统、产品安装基线迁移系统、增强工单数据修复系统、活动参与者修复系统、缺失账户链接修复系统、缺失参与者修复系统、报告者快照迁移系统、账户类型组织化迁移系统、审计和软删除系统以及回收站管理系统，**新增的附件管理系统、客户端构建系统、服务上传管理、文档工作流系统和配件主数据管理系统**：
...
SKUSeed[SKU种子数据]
ModelSKU[模型-SKU映射]
AttachmentCount[工单附件计数]
BuildClient[客户端构建]
AttachmentCheck[附件检查]
ServiceUploads[服务上传管理]
PIReports[PI和维修报告]
PartsMaster[配件主数据管理]
end
subgraph "业务逻辑层"
...
AttachmentEngine[附件管理引擎]
BuildClientEngine[客户端构建引擎]
ServiceUploadEngine[服务上传引擎]
PIReportEngine[PI报告引擎]
PartsMasterEngine[配件主数据引擎]
end
subgraph "数据访问层"
SQLite[SQLite数据库]
RemoteDB[远程数据库]
...
AttachmentSystem[附件管理系统]
BuildClientSystem[客户端构建系统]
ServiceUploadSystem[服务上传系统]
PIReportSystem[PI报告系统]
PartsMasterSystem[配件主数据系统]
end
subgraph "工具层"
SyncTool[同步工具]
RemoteExec[远程执行]
...
AttachmentEngine --> AttachmentSystem
BuildClientEngine --> BuildClientSystem
ServiceUploadEngine --> ServiceUploadSystem
PIReportEngine --> PIReportSystem
PartsMasterEngine --> PartsMasterSystem
end
```
...
**新增** 全新的工单附件计数组件，提供完整的附件数量管理和查询支持：

#### 附件计数迁移详解

```mermaid
flowchart TD
AttachmentsCount[工单附件计数迁移] --> AddColumn[添加attachments_count字段]
AddColumn --> FillCounts[填充现有计数]
FillCounts --> QueryOptimization[查询优化]
QueryOptimization --> RealTimeUpdates[实时更新机制]
RealTimeUpdates --> Complete[迁移完成]
```
...
**1. 字段定义**
- `attachments_count` INTEGER 类型，支持NULL值
- 默认值为0，表示没有附件
- 支持负值表示特殊状态（如-1表示计算中）
...
**新增** 全新的附件检查组件，提供专业的诊断和验证功能：

```mermaid
flowchart TD
AttachmentCheck[附件检查组件] --> TicketLookup[工单查找]
TicketLookup --> ActivityAttachments[活动附件查询]
ActivityAttachments --> DiagnosticCheck[诊断活动检查]
DiagnosticCheck --> RecentAttachments[最近附件查看]
RecentAttachments --> DataValidation[数据验证]
DataValidation --> Complete[检查完成]
```
...
- 支持通过工单号查找工单信息
- 显示工单的基本信息和ID
- 提供默认工单号进行测试（RMA-D-2603-0013）

**2. 附件查询功能**
- 查询工单级别的附件：`SELECT id, activity_id, file_name FROM ticket_attachments WHERE ticket_id = ?`
- 通过活动ID查询附件：`SELECT * FROM ticket_attachments WHERE activity_id IN (${activityIds.join(',')})`
- 支持诊断活动的附件检查：`SELECT * FROM ticket_attachments WHERE activity_id = 141`
- 查看数据库中的最新附件：`SELECT id, ticket_id, activity_id, file_name FROM ticket_attachments ORDER BY id DESC LIMIT 5`
...
**新增** 全新的客户端构建组件，提供安全可靠的构建流程：

#### 构建流程详解

```mermaid
flowchart TD
BuildClient[客户端构建流程] --> SetOptions[设置执行选项]
SetOptions --> ChangeDirectory[切换到客户端目录]
ChangeDirectory --> CleanDist[清理dist目录]
CleanDist --> SafeDelete[安全删除方式]
SafeDelete --> BuildProcess[执行构建]
BuildProcess --> SuccessMessage[构建成功消息]
SuccessMessage --> Complete[构建完成]
```
...
**1. 安全删除机制**
- 使用 `trash` 命令进行安全删除（如果可用）
- 降级到手动删除方式：`rm -r dist 2>/dev/null || true`
- 防止沙箱确认问题和意外删除

**2. 构建过程**
- 自动切换到客户端目录：`cd "$(dirname "$0")/../client"`
...
**4. 用户反馈**
- 构建前显示清理信息："🧹 Cleaning dist directory..."
- 构建中显示构建信息："🔨 Building client..."
- 构建完成后显示完成信息："✅ Build complete!"

### 服务上传管理组件

**新增** 全新的服务上传管理组件，提供完整的上传跟踪功能：
...
CreateTable --> UploadTracking[上传跟踪]
UploadTracking --> IndexOptimization[索引优化]
IndexOptimization --> DataValidation[数据验证]
DataValidation --> Complete[管理完成]
```
...
- `file_name`: 文件名，必填
- `file_path`: 文件路径，必填
- `file_size`: 文件大小（字节），必填
- `file_type`: 文件类型，有默认值'general'
- `upload_type`: 上传类型，默认'general'
- `uploaded_by`: 上传者ID，外键关联users表
- `uploaded_at`: 上传时间，默认当前时间

**3. 索引优化策略**
- `idx_service_uploads_type`: 按上传类型查询优化
- `idx_service_uploads_user`: 按上传者查询优化
...
**新增** 全新的文档工作流管理组件，提供完整的PI和维修报告管理：

#### 文档工作流详解

```mermaid
flowchart TD
PIReports[文档工作流系统] --> CreatePI[创建PI表]
CreatePI --> CreateReports[创建维修报告表]
CreateReports --> DocumentAudit[创建文档审计日志]
DocumentAudit --> TicketReferences[添加工单引用]
TicketReferences --> Complete[工作流完成]
...
**1. 表结构特性**
- `proforma_invoices` 表支持草稿、待审阅、批准、拒绝、发布等状态
- JSON格式的内容存储支持灵活结构
- 财务摘要字段支持快速访问
- 版本控制和软删除支持

**2. 状态管理**
- `status` 字段支持：draft、pending_review、approved、rejected、published
- 完整的工作流跟踪字段
- 审核评论和备注功能
...
**1. 报告内容**
- JSON格式的内容存储，包含header、device_info、issue_description、diagnosis、repair_process、parts_used、qa_result、warranty_terms
- 服务类型和总成本统计
- 保修信息和天数管理
...
**1. 审计记录**
- 记录所有文档操作（created、updated、submitted、reviewed、approved、rejected、published、deleted）
- 跟踪操作者和变更详情
- 支持按文档类型和ID查询

**2. 查询优化**
- `idx_doc_audit_type_id`: 按文档类型和ID查询优化
- `idx_doc_audit_action`: 按操作类型查询优化

**3. 数据结构**
- `document_type`: 文档类型（pi、repair_report）
- `document_id`: 文档ID
- `action`: 操作类型
- `user_id`、`user_name`: 操作者信息
- `changes_summary`: 变更详情（JSON）
- `comment`: 评论
- `created_at`: 时间戳

### 配件主数据组件

**新增** 全新的配件主数据管理组件，提供完整的配件和库存管理：
...
- `price_cny`、`price_usd`、`price_eur`: 多币种价格
- `cost_cny`: 成本价（内部）
- `status`: 状态（active、discontinued、pending）
- `compatible_models`: 兼容性（JSON数组）

**2. 审计和软删除**
- `created_by`、`created_at`: 创建信息
- `updated_by`、`updated_at`: 更新信息
- `is_deleted`、`deleted_at`、`deleted_by`: 软删除支持
...
**2. 来源追踪**
- `source_type`: 来源类型（hq_inventory、dealer_inventory、external_purchase、warranty_free）
- `dealer_id`、`dealer_name`: 经销商信息
- `settlement_status`: 结算状态（pending、included、waived、disputed）
...
- `total_amount_cny`、`total_amount_usd`、`total_amount_eur`: 总金额（多币种）

**3. 状态跟踪**
- `status`: 结算状态（draft、confirmed、invoiced、paid、disputed）
- `confirmed_by`、`confirmed_at`、`confirmed_notes`: 确认信息
- `invoiced_by`、`invoiced_at`、`invoice_number`: 开票信息
- `paid_by`、`paid_at`、`payment_reference`: 付款信息
...
**2. 关联信息**
- `part_id`: 配件ID
- `dealer_id`: 经销商ID（NULL表示总部库存）
- `reference_type`: 关联单据类型（restock_order、consumption、ticket）
- `reference_id`、`reference_number`: 关联单据信息

**3. 操作信息**
- `operated_by`、`operated_by_name`: 操作人信息
- `operated_at`: 操作时间，默认当前时间
...
**更新** 数据迁移脚本之间的依赖关系反映了新的账户联系人架构、产品家族分类系统、智能文档更新系统、专用数据修复系统、文件权限优化系统、新增的产品数据丰富化、用户迁移修复、RMA账户修复、统一工单系统准备系统、产品安装基线迁移系统、增强工单数据修复系统、活动参与者修复系统、缺失账户链接修复系统、缺失参与者修复系统、报告者快照迁移系统、账户类型组织化迁移系统、审计和软删除系统以及回收站管理系统，**新增的附件管理系统、客户端构建系统、服务上传管理、文档工作流系统和配件主数据管理系统**的协同工作：
...
AttachmentCountSQL[039_add_attachments_count.sql]
BuildClientSH[build-client.sh]
AttachmentCheckJS[check_attachments.js]
ServiceUploadsSQL[032_service_uploads.sql]
PIReportsSQL[030_pi_and_report_tables.sql]
PartsMasterSQL[031_parts_master.sql]
end
subgraph "SQL迁移"
...
AttachmentCountSQL --> AttachmentCheckJS
ServiceUploadsSQL --> PIReportsSQL
PIReportsSQL --> PartsMasterSQL
BuildClientSH --> AttachmentCheckJS
AttachmentCountSQL --> ServiceUploadsSQL
PIReportsSQL --> AttachmentCheckJS
PartsMasterSQL --> AttachmentCheckJS
end
...
BetterSQLite --> AttachmentCountSQL
BetterSQLite --> ServiceUploadsSQL
BetterSQLite --> PIReportsSQL
BetterSQLite --> PartsMasterSQL
...
Path --> AttachmentCountSQL
Path --> ServiceUploadsSQL
Path --> PIReportsSQL
Path --> PartsMasterSQL
...
AttachmentCountSQL --> BetterSQLite
ServiceUploadsSQL --> BetterSQLite
PIReportsSQL --> BetterSQLite
PartsMasterSQL --> BetterSQLite
BuildClientSH --> Path
AttachmentCheckJS --> BetterSQLite
end
```
...
- [server/service/migrations/036_add_missing_product_fields.sql:30-38](file://server/service/migrations/036_add_missing_product_fields.sql#L30-L38)
- [server/migrations/039_add_attachments_count.sql:1-5](file://server/migrations/039_add_attachments_count.sql#L1-L5)
- [scripts/build-client.sh:1-5](file://scripts/build-client.sh#L1-L5)
- [server/scripts/check_attachments.js:1-5](file://server/scripts/check_attachments.js#L1-L5)
- [server/service/migrations/032_service_uploads.sql:1-5](file://server/service/migrations/032_service_uploads.sql#L1-L5)
- [server/service/migrations/030_pi_and_report_tables.sql:1-5](file://server/service/migrations/030_pi_and_report_tables.sql#L1-L5)
- [server/service/migrations/031_parts_master.sql:1-5](file://server/service/migrations/031_parts_master.sql#L1-L5)
...
**更新** 新增账户联系人架构、产品家族分类系统、智能文档更新系统、专用数据修复系统、文件权限优化系统、产品数据丰富化、用户迁移修复、RMA账户修复、统一工单系统准备系统、产品安装基线迁移系统、增强工单数据修复系统、活动参与者修复系统、缺失账户链接修复系统、缺失参与者修复系统、报告者快照迁移系统、账户类型组织化迁移系统、审计和软删除系统以及回收站管理系统的性能考虑，**新增的附件管理系统、客户端构建系统、服务上传管理、文档工作流系统和配件主数据管理系统的性能优化**：
...
**更新** 账户联系人架构、产品家族分类迁移、智能文档更新、专用数据修复、文件权限优化、产品数据丰富化、用户迁移修复、RMA账户修复、统一工单系统准备、产品安装基线迁移、增强工单数据修复、活动参与者修复、缺失账户链接修复、缺失参与者修复、报告者快照迁移、账户类型组织化迁移、审计和软删除系统以及回收站管理，**附件管理系统、客户端构建系统、服务上传管理、文档工作流系统和配件主数据管理**的性能优化：
...
**更新** 新增账户联系人架构、产品家族分类、智能文档更新、专用数据修复、文件权限优化、产品数据丰富化、用户迁移修复、RMA账户修复、统一工单系统准备、产品安装基线迁移、增强工单数据修复、活动参与者修复、缺失账户链接修复、缺失参与者修复、报告者快照迁移、账户类型组织化迁移、审计和软删除系统以及回收站管理相关的故障排除，**新增的附件管理系统、客户端构建系统、服务上传管理、文档工作流系统和配件主数据管理相关的故障排除**：
...
- **症状**：产品字段扩展失败
- **原因**：字段添加失败或索引创建错误
- **solve**：运行036_add_missing_product_fields.sql迁移脚本，检查索引完整性

#### 工单附件计数问题
- **症状**：工单附件计数不准确
- **原因**：附件计数字段缺失或数据填充错误
- **解决**：运行039_add_attachments_count.sql迁移脚本，检查计数逻辑

#### 服务上传管理问题
- **症状**：服务上传记录不完整
- **原因**：上传表创建失败或索引错误
- **解决**：运行032_service_uploads.sql迁移脚本，检查表结构完整性

#### 文档工作流问题
- **症状**：PI或维修报告记录异常
- **原因**：文档表创建失败或索引错误
- **解决**：运行030_pi_and_report_tables.sql迁移脚本，检查表结构完整性

#### 配件主数据问题
- **症状**：配件数据不完整或关联错误
- **原因**：配件表创建失败或索引错误
- **solve**：运行031_parts_master.sql迁移脚本，检查表结构完整性

#### 客户端构建问题
- **症状**：客户端构建失败或构建过程异常
- **原因**：构建脚本执行错误或依赖问题
- **解决**：检查build-client.sh脚本，验证Node.js环境和依赖

#### 附件检查问题
- **症状**：附件检查脚本执行失败
- **原因**：数据库连接问题或查询错误
- **解决**：检查check_attachments.js脚本，验证数据库连接和查询语句
...
33. **工单附件计数验证**：验证附件计数功能的准确性
34. **服务上传验证**：验证服务上传管理的准确性
35. **文档工作流验证**：验证文档工作流功能的准确性
36. **配件主数据验证**：验证配件主数据管理的准确性
37. **客户端构建验证**：验证客户端构建功能的准确性
38. **附件检查验证**：验证附件检查功能的准确性
...
35. **工单附件计数系统**：新增完整的工单附件计数功能，支持高效查询和统计
36. **客户端构建系统**：新增安全的本地构建流程，避免沙箱确认问题
37. **附件检查系统**：新增专业的附件检查和诊断工具，便于问题排查
38. **服务上传管理系统**：新增服务上传和文档管理工作流，支持保修发票和其他服务附件的跟踪
39. **文档工作流系统**：新增PI和维修报告的完整工作流管理，支持文档状态和版本控制
40. **配件主数据管理系统**：新增配件主数据和库存集成管理，支持维修配件的完整生命周期管理
