...
4. [架构总览](#架构总览)
5. [组件详解](#组件详解)
6. [Service模块组件](#service模块组件)
7. [通知中心组件](#通知中心组件)
8. [SLA组件库](#sla组件库)
9. [工作区组件群](#工作区组件群)
10. [Workspace组件集合](#workspace组件集合)
11. [新增组件详解](#新增组件详解)
12. [客户管理模态组件](#客户管理模态组件)
13. [调试覆盖层组件](#调试覆盖层组件)
14. [主题系统](#主题系统)
15. [样式系统升级](#样式系统升级)
16. [依赖关系分析](#依赖关系分析)
...
**更新** 本次更新重点增加了三大核心组件的完整实现：ActionBufferModal（流程缓冲确认）、AssigneeSelector（智能指派选择器）、SubmitDiagnosticModal（诊断报告提交）。这些新增组件与现有的UnifiedTicketDetail深度集成，形成了完整的工单流程操作体系。同时增强了MentionCommentInput、ParticipantsSidebar、AccountContactSelector等现有组件的功能，提升了用户体验和开发效率。
...
- src/store：基于 Zustand 的状态管理（认证、提示、确认对话框、主题）
...
**图表来源**
- [main.tsx](file://client/src/main.tsx#L1-L25)
- [App.tsx](file://client/src/App.tsx#L124-L200)
- [index.css](file://client/src/index.css#L1-L101)
...
- [translations.ts](file://client/src/i18n/translations.ts#L1-L800)
...
- [WorkspacePage.tsx](file://client/src/components/Service/WorkspacePage.tsx#L1-L753)
- [NotificationCenter.tsx](file://client/src/components/Notifications/NotificationCenter.tsx#L1-L438)
- [SlaComponents.tsx](file://client/src/components/Tickets/SlaComponents.tsx#L1-L335)
- [WorkspaceComponents.tsx](file://client/src/components/Workspace/WorkspaceComponents.tsx#L1-L468)
...
- [TicketDetailComponents.tsx](file://client/src/components/Workspace/TicketDetailComponents.tsx#L1-L418)
- [ViewAsComponents.tsx](file://client/src/components/Workspace/ViewAsComponents.tsx#L1-L306)
- [DebugOverlay.tsx](file://client/src/components/DebugOverlay.tsx#L1-L255)
- [ContactCleaningModal.tsx](file://client/src/components/Service/ContactCleaningModal.tsx#L1-L162)
- [ConvertIndividualModal.tsx](file://client/src/components/Service/ConvertIndividualModal.tsx#L1-L204)
- [LinkCorporateModal.tsx](file://client/src/components/Service/LinkCorporateModal.tsx#L1-L170)
- [AccountContactSelector.tsx](file://client/src/components/AccountContactSelector.tsx#L1-L493)
- [ActionBufferModal.tsx](file://client/src/components/Workspace/ActionBufferModal.tsx#L1-L423)
- [AssigneeSelector.tsx](file://client/src/components/Workspace/AssigneeSelector.tsx#L1-L356)
- [SubmitDiagnosticModal.tsx](file://client/src/components/Workspace/SubmitDiagnosticModal.tsx#L1-L281)

**章节来源**
- [main.tsx](file://client/src/main.tsx#L1-L25)
- [vite.config.ts](file://client/vite.config.ts#L1-L82)
...
**图表来源**
- [useCachedFiles.ts](file://client/src/hooks/useCachedFiles.ts#L27-L86)
...
**章节来源**
- [ServiceNavigation.tsx](file://client/src/components/Service/ServiceNavigation.tsx#L1-L347)
- [index.ts](file://client/src/components/Service/index.ts#L1-L3)
...
- [ServiceOverviewPage.tsx](file://client/src/components/Service/ServiceOverviewPage.tsx#L302-L348)
...
- [WorkspacePage.tsx](file://client/src/components/Service/WorkspacePage.tsx#L296-L310)
...
**图表来源**
- [CustomerContextSidebar.tsx](file://client/src/components/Service/CustomerContextSidebar.tsx#L196-L247)
- [CustomerContextSidebar.tsx](file://client/src/components/Service/CustomerContextSidebar.tsx#L250-L409)
- [CustomerContextSidebar.tsx](file://client/src/components/Service/CustomerContextSidebar.tsx#L769-L800)

**章节来源**
- [CustomerContextSidebar.tsx](file://client/src/components/Service/CustomerContextSidebar.tsx#L1-L824)
...
**图表来源**
- [AttachmentZone.tsx](file://client/src/components/Service/AttachmentZone.tsx#L34-L104)
...
**图表来源**
- [NotificationCenter.tsx](file://client/src/components/Notifications/NotificationCenter.tsx#L238-L286)
- [NotificationCenter.tsx](file://client/src/components/Notifications/NotificationCenter.tsx#L276-L283)

**章节来源**
- [NotificationCenter.tsx](file://client/src/components/Notifications/NotificationCenter.tsx#L1-L438)
- [index.ts](file://client/src/components/Notifications/index.ts#L1-L7)
...
**图表来源**
- [SlaComponents.tsx](file://client/src/components/Tickets/SlaComponents.tsx#L47-L70)
- [SlaComponents.tsx](file://client/src/components/Tickets/SlaComponents.tsx#L81-L144)
- [SlaComponents.tsx](file://client/src/components/Tickets/SlaComponents.tsx#L157-L261)
...
- [WorkspaceComponents.tsx](file://client/src/components/Workspace/WorkspaceComponents.tsx#L130-L223)
- [WorkspaceComponents.tsx](file://client/src/components/Workspace/WorkspaceComponents.tsx#L236-L346)
...
**图表来源**
- [OverviewDashboard.tsx](file://client/src/components/Workspace/OverviewDashboard.tsx#L409-L491)
- [OverviewDashboard.tsx](file://client/src/components/Workspace/OverviewDashboard.tsx#L449-L473)
...
**图表来源**
- [MentionCommentInput.tsx](file://client/src/components/Workspace/MentionCommentInput.tsx#L29-L102)

**章节来源**
- [MentionCommentInput.tsx](file://client/src/components/Workspace/MentionCommentInput.tsx#L1-L446)
- [TicketDetailComponents.tsx](file://client/src/components/Workspace/TicketDetailComponents.tsx#L179-L179)
...
**图表来源**
- [ParticipantsSidebar.tsx](file://client/src/components/Workspace/ParticipantsSidebar.tsx#L55-L67)

**章节来源**
- [ParticipantsSidebar.tsx](file://client/src/components/Workspace/ParticipantsSidebar.tsx#L1-L401)
...
**图表来源**
- [TicketDetailComponents.tsx](file://client/src/components/Workspace/TicketDetailComponents.tsx#L49-L173)
- [TicketDetailComponents.tsx](file://client/src/components/Workspace/TicketDetailComponents.tsx#L179-L179)
...
**图表来源**
- [ViewAsComponents.tsx](file://client/src/components/Workspace/ViewAsComponents.tsx#L31-L76)
- [ViewAsComponents.tsx](file://client/src/components/Workspace/ViewAsComponents.tsx#L89-L259)
- [ViewAsComponents.tsx](file://client/src/components/Workspace/ViewAsComponents.tsx#L265-L299)
...
**图表来源**
- [ActionBufferModal.tsx](file://client/src/components/Workspace/ActionBufferModal.tsx#L27-L244)
- [ActionBufferModal.tsx](file://client/src/components/Workspace/ActionBufferModal.tsx#L268-L345)
...
**图表来源**
- [AssigneeSelector.tsx](file://client/src/components/Workspace/AssigneeSelector.tsx#L121-L146)
- [AssigneeSelector.tsx](file://client/src/components/Workspace/AssigneeSelector.tsx#L148-L186)
...
**图表来源**
- [SubmitDiagnosticModal.tsx](file://client/src/components/Workspace/SubmitDiagnosticModal.tsx#L37-L84)
...
**章节来源**
- [UnifiedTicketDetail.tsx](file://client/src/components/Workspace/UnifiedTicketDetail.tsx#L563-L593)
- [UnifiedTicketDetail.tsx](file://client/src/components/Workspace/UnifiedTicketDetail.tsx#L709-L728)
- [UnifiedTicketDetail.tsx](file://client/src/components/Workspace/UnifiedTicketDetail.tsx#L1529-L1549)
...
**图表来源**
- [ContactCleaningModal.tsx](file://client/src/components/Service/ContactCleaningModal.tsx#L37-L59)
...
**图表来源**
- [ConvertIndividualModal.tsx](file://client/src/components/Service/ConvertIndividualModal.tsx#L34-L53)
...
**图表来源**
- [LinkCorporateModal.tsx](file://client/src/components/Service/LinkCorporateModal.tsx#L33-L63)
...
**图表来源**
- [AccountContactSelector.tsx](file://client/src/components/AccountContactSelector.tsx#L114-L133)
- [AccountContactSelector.tsx](file://client/src/components/AccountContactSelector.tsx#L213-L228)
- [AccountContactSelector.tsx](file://client/src/components/AccountContactSelector.tsx#L320-L327)
...
**图表来源**
- [DebugOverlay.tsx](file://client/src/components/DebugOverlay.tsx#L46-L77)
- [DebugOverlay.tsx](file://client/src/components/DebugOverlay.tsx#L149-L201)
- [DebugOverlay.tsx](file://client/src/components/DebugOverlay.tsx#L83-L143)
- [DebugOverlay.tsx](file://client/src/components/DebugOverlay.tsx#L207-L246)
- [main.tsx](file://client/src/main.tsx#L20-L22)
- [App.tsx](file://client/src/App.tsx#L158-L159)
- [AdminSettings.tsx](file://client/src/components/Admin/AdminSettings.tsx#L1333-L1333)

**章节来源**
- [DebugOverlay.tsx](file://client/src/components/DebugOverlay.tsx#L1-L255)
- [main.tsx](file://client/src/main.tsx#L1-L25)
- [App.tsx](file://client/src/App.tsx#L158-L159)
- [AdminSettings.tsx](file://client/src/components/Admin/AdminSettings.tsx#L1324-L1335)
...
**图表来源**
- [useThemeStore.ts](file://client/src/store/useThemeStore.ts#L19-L37)
...
**章节来源**
- [App.tsx](file://client/src/App.tsx#L814-L1000)
- [useThemeStore.ts](file://client/src/store/useThemeStore.ts#L39-L67)
...
- [useThemeStore.ts](file://client/src/store/useThemeStore.ts#L1-L86)
- [App.tsx](file://client/src/App.tsx#L340-L570)
- [AdminSettings.tsx](file://client/src/components/Admin/AdminSettings.tsx#L1185-L1212)
...
- [useThemeStore.ts](file://client/src/store/useThemeStore.ts#L19-L37)
- [vite.config.ts](file://client/vite.config.ts#L62-L82)
- [DebugOverlay.tsx](file://client/src/components/DebugOverlay.tsx#L46-L70)
- [ActionBufferModal.tsx](file://client/src/components/Workspace/ActionBufferModal.tsx#L268-L345)
- [AssigneeSelector.tsx](file://client/src/components/Workspace/AssigneeSelector.tsx#L131-L146)
- [SubmitDiagnosticModal.tsx](file://client/src/components/Workspace/SubmitDiagnosticModal.tsx#L37-L84)
- [AccountContactSelector.tsx](file://client/src/components/AccountContactSelector.tsx#L182-L198)
- [ParticipantsSidebar.tsx](file://client/src/components/Workspace/ParticipantsSidebar.tsx#L134-L175)
...
- [App.tsx](file://client/src/App.tsx#L128-L150)
- [useToast.ts](file://client/src/store/useToast.ts#L17-L40)
- [useThemeStore.ts](file://client/src/store/useThemeStore.ts#L39-L67)
- [useLanguage.ts](file://client/src/i18n/useLanguage.ts#L1-L59)
- [useCachedFiles.ts](file://client/src/hooks/useCachedFiles.ts#L58-L86)
- [DebugOverlay.tsx](file://client/src/components/DebugOverlay.tsx#L46-L70)
- [ActionBufferModal.tsx](file://client/src/components/Workspace/ActionBufferModal.tsx#L246-L266)
- [AssigneeSelector.tsx](file://client/src/components/Workspace/AssigneeSelector.tsx#L121-L146)
- [SubmitDiagnosticModal.tsx](file://client/src/components/Workspace/SubmitDiagnosticModal.tsx#L37-L41)
- [ContactCleaningModal.tsx](file://client/src/components/Service/ContactCleaningModal.tsx#L37-L59)
- [ConvertIndividualModal.tsx](file://client/src/components/Service/ConvertIndividualModal.tsx#L34-L53)
- [LinkCorporateModal.tsx](file://client/src/components/Service/LinkCorporateModal.tsx#L33-L63)
- [AccountContactSelector.tsx](file://client/src/components/AccountContactSelector.tsx#L114-L133)
...
**更新** 本次Workspace组件集合的完整实现和三大核心组件的引入标志着前端架构的重要里程碑，新增的ActionBufferModal（流程缓冲确认）、AssigneeSelector（智能指派选择器）、SubmitDiagnosticModal（诊断报告提交）等组件，以及DebugOverlay调试覆盖层，进一步完善了前端架构的组件化设计和开发工具链。
