...
## 更新摘要
**所做更改**
- 更新了ConfirmModal组件的倒计时机制实现细节
- 增强了ConfirmDialog组件的视觉效果和交互体验
- 完善了危险操作识别和主题色彩映射逻辑
- 优化了模态框的动画效果和过渡效果
- 改进了状态管理和组件间通信机制
...
**更新** 增强了倒计时显示逻辑，支持动态倒计时显示和按钮禁用状态
...
**更新** 改进了倒计时状态管理，增加了实时倒计时显示和按钮状态同步
