...
- 新增了基于角色的中间件实现细节和部门节点映射
- 新增了文件权限表优化的详细实现和迁移脚本分析
- 更新了角色权限矩阵，反映新的 Admin/Exec/MS/GE/OP/RD/Dealer 七层级体系
...
## 简介
本文件为 Longhorn 权限管理系统的技术文档，围绕 RBAC（基于角色的访问控制）模型展开，详细阐述七层级权限体系（Admin、Exec、MS、GE、OP、RD、Dealer）与路径权限控制、动态权限验证及权限缓存机制。文档涵盖权限规则定义、存储与查询优化、API 接口规范以及前端权限控制组件的使用指南，并提供权限审计、异常处理与安全加固建议。

**重要更新**：本次更新反映了权限中间件的大幅重构，实现了新的"隔离与穿透"原则，支持部门感知过滤和 JIT（Just-In-Time）穿透机制，新增工作区计数端点和增强的授权逻辑。系统现已支持七层级权限体系：Admin/Exec/MS/GE/OP/RD/Dealer。
...
- [AuthManager.swift:1-195](file://ios/LonghornApp/Services/AuthManager.swift#L1-L195)
- [APIClient.swift:1-386](file://ios/LonghornApp/Services/APIClient.swift#L1-L386)
- [Permission.swift:1-27](file://ios/LonghornApp/Models/Permission.swift#L1-L27)
- [UserManagement.tsx:1-895](file://client/src/components/UserManagement.tsx#L1-L895)
- [DepartmentManagement.tsx:1-483](file://client/src/components/DepartmentManagement.tsx#L1-L483)
- [AdminPanel.tsx:1-179](file://client/src/components/AdminPanel.tsx#L1-L179)
- [WorkspaceComponents.tsx:1-470](file://client/src/components/Workspace/WorkspaceComponents.tsx#L1-L470)
- [permission.js:1-232](file://server/service/middleware/permission.js#L1-L232)
- [migrate_file_permissions.js:1-139](file://server/migrate_file_permissions.js#L1-L139)
...
- 管理服务
  - iOS：封装 /api/admin/* 接口，包括用户、部门、系统统计与权限管理。
...
**图表来源**
- [APIClient.swift:331-375](file://ios/LonghornApp/Services/APIClient.swift#L331-L375)
- [AuthManager.swift:114-123](file://ios/LonghornApp/Services/AuthManager.swift#L114-L123)
- [permission.js:15-25](file://server/service/middleware/permission.js#L15-L25)
- [permission.js:28-77](file://server/service/middleware/permission.js#L28-L77)
...
APIClient --> User : "管理"
APIClient --> Permission : "管理"
```

**图表来源**
- [Permission.swift:10-26](file://ios/LonghornApp/Models/Permission.swift#L10-L26)
- [APIClient.swift:68-108](file://ios/LonghornApp/Services/APIClient.swift#L68-L108)

**章节来源**
- [Permission.swift:4-8](file://ios/LonghornApp/Models/Permission.swift#L4-L8)
...
**章节来源**
- [permission.js:52-77](file://server/service/middleware/permission.js#L52-L77)
...
**章节来源**
- [permission.js:83-182](file://server/service/middleware/permission.js#L83-L182)
...
**章节来源**
- [UserManagement.tsx:230-240](file://client/src/components/UserManagement.tsx#L230-L240)
- [DepartmentManagement.tsx:124-142](file://client/src/components/DepartmentManagement.tsx#L124-L142)
...
**章节来源**
- [AuthManager.swift:94-123](file://ios/LonghornApp/Services/AuthManager.swift#L94-L123)
...
**章节来源**
- [migrate_file_permissions.js:75-97](file://server/migrate_file_permissions.js#L75-L97)
...
**章节来源**
- [AuthManager.swift:44-69](file://ios/LonghornApp/Services/AuthManager.swift#L44-L69)
- [APIClient.swift:68-108](file://ios/LonghornApp/Services/APIClient.swift#L68-L108)
- [UserManagement.tsx:219-228](file://client/src/components/UserManagement.tsx#L219-L228)
- [DepartmentManagement.tsx:70-82](file://client/src/components/DepartmentManagement.tsx#L70-L82)
...
- iOS
  - AuthManager.swift：封装管理 API，提供 fetchUsers/fetchPermissions/grantPermission/deletePermission 等方法。
  - Permission.swift：权限数据模型，用于展示与交互。

**更新**：新增了工作空间组件和计数显示功能。

**章节来源**
- [AdminPanel.tsx:10-33](file://client/src/components/AdminPanel.tsx#L10-L33)
- [UserManagement.tsx:167-188](file://client/src/components/UserManagement.tsx#L167-L188)
- [DepartmentManagement.tsx:32-44](file://client/src/components/DepartmentManagement.tsx#L32-L44)
- [WorkspaceComponents.tsx:48-119](file://client/src/components/Workspace/WorkspaceComponents.tsx#L48-L119)
...
**章节来源**
- [APIClient.swift:10-35](file://ios/LonghornApp/Services/APIClient.swift#L10-L35)
- [APIClient.swift:287-315](file://ios/LonghornApp/Services/APIClient.swift#L287-L315)
- [AuthManager.swift:71-89](file://ios/LonghornApp/Services/AuthManager.swift#L71-L89)
...
Workspace["WorkspaceComponents.tsx"] --> APIs
...
**章节来源**
- [APIClient.swift:347-353](file://ios/LonghornApp/Services/APIClient.swift#L347-L353)
- [AuthManager.swift:114-123](file://ios/LonghornApp/Services/AuthManager.swift#L114-L123)
- [migrate_file_permissions.js:1-139](file://server/migrate_file_permissions.js#L1-L139)
- [permission.js:83-182](file://server/service/middleware/permission.js#L83-L182)
